...
namespace MyRestfulApp.Controllers.Api
{
    ...
    public class UsuariosController : ApiController
    {
        ...
        {
            List<Models.UserModel> users = new Services.UserServices().GetUsers();
        ...
        {
            Dtos.UsuarioDto user = new Services.UserServices().GetUser(IDusuario);
        ...
        {
            string userOk = new Services.UserServices().AddUser(usuarioDto);

            if (!string.IsNullOrEmpty(userOk))
                return BadRequest(userOk);

            Dtos.UsuarioDto user = new Services.UserServices().GetUser(usuarioDto.id);
        ...
        {
            string userOk = new Services.UserServices().UpdateUser(usuarioDto);
        ...
        {
            string userOk = new Services.UserServices().DeleteUser(userID);

            if (!string.IsNullOrEmpty(userOk))
                return BadRequest(userOk);

            Dtos.UsuarioDto user = new Services.UserServices().GetUser(userID);
